...
from .sm64_utility import (
    starSelectWarning,
    check_obj_is_room,
    duplicate_and_create_initial_geolayout_hierarchy,
    ProcessGeolayoutContext,
    process_geolayout,
)
...
def convertObjectToGeolayout(
    ...
    try:
        ...
        process_context = ProcessGeolayoutContext(
            fModel, geolayoutGraph.startGeolayout, geolayoutGraph, convertTextureData, convertTransformMatrix
        )
